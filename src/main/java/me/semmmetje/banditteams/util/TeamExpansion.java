...
public final class TeamExpansion extends PlaceholderExpansion {
  ...
  @Override public @Nullable String onRequest(OfflinePlayer player,@NotNull String params){if(player==null)return "";if(!params.equalsIgnoreCase("name"))return null;Team team=plugin.teams().teamOf(player.getUniqueId());return team==null?"No Team":team.name();}
}
